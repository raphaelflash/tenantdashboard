...
<div class="h-screen flex overflow-hidden bg-gray-100">
  ...
  <div class="mt-5 flex lg:mt-0 lg:ml-4">
    ...
    <span class="ml-3 relative shadow-sm rounded-md sm:hidden">
      <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-gray-700 hover:bg-gray-600 focus:outline-none focus:shadow-outline-gray focus:border-gray-800 transition duration-150 ease-in-out" id="mobile-menu" aria-haspopup="true">
        More
      ...
      -->
      <div class="origin-top-left absolute left-0 mt-2 -ml-1 w-48 rounded-md shadow-lg" aria-labelledby="mobile-menu" role="menu">
